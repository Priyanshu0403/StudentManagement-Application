...
<body>
    ...
    <div class="navbar row">
        ...
        <div class="LogOutClass col col-2"><a href="index.html">LogOut <i class="fa-solid fa-right-from-bracket"></i></a></div>
    </div>
    <!-- Sidebar -->
    <div class="sidebar">
        <h2>Sidebar</h2>
        ...
        <a href="#" class="deleteButton">Delete Student</a>
        <a href="StudentList.jsp" class="viewStdListButton">View Student List</a>
